...
contract StableMath {
    ...
    mapping(uint256 => mapping(uint256 => mapping(uint256 => uint256))) _calculateInvariant_map;
    ...
    */
    ...
    mapping(uint256 => mapping(uint256 => mapping(uint256 => mapping(uint256 => mapping(uint256 => uint256))))) _getTokenBalanceGivenInvariantAndAllOtherBalances_map;
